    ...
    subSections: [
      {
        ...
        items: [
          ...
          { label: "Payment", icon: <Wallet size={20} />, href:"/Accounts/accounts/payment-entry" },
          { label: "Receipt", icon: <Receipt size={20} />, href:"/Accounts/accounts/receipt-entry" },
          { label: "Chart Of Accounts", icon: <BarChart2 size={20} />, href:"/Accounts/accounts/chart-account" },
      ...
      },
      {
        ...
        items: [
          { label: "Bank Reconciliation", icon: <Landmark size={20} />, href:"/Accounts/accounts/bank-reconciliation" },
          { label: "Supplier Payment", icon: <HandCoins size={20} />, href:"/Accounts/accounts/supplier-payment-entry" },
          { label: "Customer Receipt", icon: <CreditCard size={20} />, href:"/Accounts/accounts/customer-receipt-entry" },
        ],
      },
    ],
  },
    ...
    subSections: [
      {
        ...
        items: [
          ...
          { label: "Trial Balance", icon: <Scale size={20} />, href:"/Accounts/reports/trial-balance" },
          { label: "Pending Payments", icon: <StickyNote size={20} /> },
          { label: "P&L Reports", icon: <TrendingUp size={20} />, href:"/Accounts/reports/profit-and-loss" },
          { label: "Balance Sheet", icon: <FileBarChart size={20} />, href:"/Accounts/reports/balance-sheet" },
